<script>
  export default {
    ...
    mounted() {
      this.fetchData(); // Вызываем метод получения данных при монтировании компонента
    },
    methods: {
      async fetchData() {
        try {
